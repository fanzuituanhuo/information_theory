...
\]
The weak law of large numbers says $N_1(X^n)/n\to p$ in probability. Thus, for
...
without extra assumptions. (For the AEP's i.i.d. variables both do hold:
finite variance gives $L^2$ convergence, and the strong law of large numbers
gives almost-sure convergence; convergence in probability is the weakest of
the three --- and all that weak typicality needs.)

\block{The weak law of large numbers}

\begin{theorem}[weak law of large numbers]\label{thm:wlln}
Let $Y_1,Y_2,\ldots$ be i.i.d.\ with finite mean $\mu=\E[Y_1]$ and finite
variance. Then
\[
