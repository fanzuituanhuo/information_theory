...
\midrule
necessity & uniquely decodable $\Longrightarrow \sum_xD^{-\ell_x}\le1$\\
sufficiency & integer lengths with $\sum_xD^{-\ell_x}\le1$
...
$|C^*(x^n)|=\sum_{i=1}^n\ell_{x_i}$. Expanding the $n$th power gives
\[
  K^n
